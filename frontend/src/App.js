            ...
            <div key={mood.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={() => setShowDeleteConfirm(mood)}
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-sm mx-4 shadow-xl">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Delete Mood Entry</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete the mood entry for {showDeleteConfirm.entry_date}?
              <br />
              <span className="font-semibold text-gray-800">
                {showDeleteConfirm.emoji} {MOODS[showDeleteConfirm.mood_score].label}
              </span>
            </p>
            <div className="flex space-x-3">
              ...
              <button
                onClick={() => deleteMoodEntry(showDeleteConfirm.entry_date)}
